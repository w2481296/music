		...
		for(var i=0;i<navList.length;i++){
			 navData+= "<li class='nav-item'><a href='javascript:;'><i class='my-icon nav-icon icon_1'></i><span>"+navList[i].p+"</span><i class='my-icon nav-more'></i></a><ul>";
				if(i==0){
						...
						navData+="<li><a href='javascript:;' _link='showIndex27.do'><span>添加用户</span></a></li><li><a href='javascript:;' _link='showIndex12.do'><span>修改密码</span></a></li><li><a href='javascript:;' _link='showIndex26.do'><span>登陆日志</span></a></li>";
				}
				navData+="</ul></li>";
			}
		$('#aat').html(navData);
