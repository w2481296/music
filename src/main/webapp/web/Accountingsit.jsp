	...
	$.ajax({
		...
		success : function(result) {
 			...
 			for(var i =0;i<allNum;i++){
 				var id= result[i].id;
 				var inKind = result[i].inKind!=null?result[i].inKind:"";
 				...
 				var inProfit = result[i].inProfit!=null?result[i].inProfit:"";
				...
				'<td>'+id+'</td>'+
				'<td>'+inKind+'</td>'+
				'<td><div class="c-999 f-12"><u style="cursor:pointer" class="text-primary" onclick="member_show('+"'"+inName+"'"+','+"'showindex1.do',"+"'10001',"+"'360',"+"'400'"+')">'+inName+'</u></div></td>'+
				'<td>'+inType+'</td>'+
