...
<body>
				...
				<div id="wrap">
					<c:forEach items="${list}" var="goods">
						<div class="lf" id="d1">
							...
							<div class="describe">
								<p onclick="toItemInfo(${goods.id})"
									style="width: 230px; height: 14px; overflow: hidden;">${goods.title}</p>
	...
	<div align="center" style="font-size: 20px">共${count}种商品|共${pageSize}页|
