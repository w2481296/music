...
$(document).ready(function () {
    $('#DataTables_Table_0').DataTable({
        ...
        "columnDefs" : [ {
        	...
        	var id = row.id;
        	var html = '<a title='+"'编辑'"+' href="javascript:;" onclick="member_show('+"'编辑',"+"'../main/showIndex13.do',"+"'"+id+"'"+','+"'800',"+"'620'"+')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="member_del(this,'+id+')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>';
        	return html;
      		}},
      		{
            	"targets" : 0,//操作按钮目标列
