...
<div class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl" style="margin-top: 0px;">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly id="insName" name="insName">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">类型：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  readonly id="insType" name="insType">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">规格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly id="insSpecifications" name="insSpecifications">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">库存数量：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly id="insQty" name="insQty">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">厂商：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text"  id="insManufacturers" readonly name="insManufacturers" class="input-text">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:240px;">
				<input type="text" id="insPricing" readonly name="insPricing" class="input-text" style="width:90%">
				元</div>
		</div>
		<!-- <div class="row cl">
