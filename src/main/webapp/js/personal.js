...
$(function() {
	/*
	 * $(".swmr_normal").click(function(){ setDefault(this); })
	 */
})
...
function setDefault(e) {
	...
	if ($(parent).siblings().hasClass("aim_active")) {
		...
		$(parent).siblings().children(".dzmc_active")
				.removeClass("dzmc_active").addClass("dzmc_normal");
		$(parent).siblings().children(".swmr_normal").html("设为默认")
	}
	$(parent).addClass("aim_active");
	$(parent).children(".dzmc_normal").removeClass("dzmc_normal").addClass(
			"dzmc_active");
	$(e).html("");
